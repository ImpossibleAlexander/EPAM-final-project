...
public class TicketTest {
	...
	public void toStringTest() {
		String expected = "Ticket [id=" + ticket.getId() + ", trainNumber=" + ticket.getTrainNumber()
				+ ", ticketNumber=" + ticket.getTicketNumber() + ", departureStation=" + ticket.getDepartureStation()
				+ ", destinationStation=" + ticket.getDestinationStation() + ", departureDateAndTime=" + ticket.getDepartureDateAndTime()
				+ ", destinationDateAndTime=" + ticket.getDestinationDateAndTime() + ", place=" + ticket.getPlace() + ", price=" + ticket.getPrice() + "]";
